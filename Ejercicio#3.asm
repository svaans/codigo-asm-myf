# El programa calcula el valor que se encuentra en la posici�n
...
# que se encuentra en esa posici�n, en este caso "21".
...
# Leer el valor "dato" como tipo entero
	...
	move $t2, $v0   # Movemos el valor a n a la direcci�n $t2
# Funci�n para llamar a Fibonacci y obtener su valor #dato
	move $a0, $t2
	move $v0, $t2
	jal fibonacci   # Llama fibonacci (dato)
	move $t3, $v0   # Resulatdo esta en la direcci�n $t3
# Mensaje y dato
...
# Calcular y devolver el n�mero de Fibonacci
...
# Llamada al Fibonacci (dato - 1)
	sub $sp, $sp, 4   # Almacenamiento de la direcci�n del retorno de la pila
	sw $ra, 0($sp)
	...
	lw $ra, 0($sp)   # Restaura la direcci�n de retorno de la pila
	add $sp, $sp, 4
...
zero:
	li $v0, 0 # Funci�n que retorno los el valor 0
	jr $ra 

one:
	li $v0, 1 # Funci�n que retorno los el valor 1
	jr $ra
